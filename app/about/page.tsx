    ...
    <div className="mx-auto flex max-w-3xl flex-col gap-[var(--section-gap)]">
      ...
      <section className="space-y-3 rounded-xl border border-border bg-surface p-5">
        ...
        <p className="leading-relaxed text-foreground/90">
          ...
          students prepare classroom activities that emphasise phoneme
          awareness rather than plain spelling drills. Teachers configure an
          activity in this web app, preview how it plays, and download a single
          HTML file for use in any normal browser — including offline classroom
          machines.
        </p>
        <p className="leading-relaxed text-foreground/90">
      ...
      <section className="rounded-xl border border-border bg-surface p-5">
        <h2 className="text-xl font-semibold">How-to video</h2>
        <p className="mt-2 text-sm text-absent">
          A walkthrough of the builder. Add{" "}
          <code className="rounded bg-surface-muted px-1">public/howto.mp4</code>{" "}
